                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.students.show', $item->id) }}"><span class="bi-eye mr-2"></span></a>
                                <a href="{{ route('admin.students.edit', $item->id) }}"><span class="bi-pencil-square text-[16px]"></span></a>
                            </td>
                        </tr>
                        @empty
                        @endforelse
