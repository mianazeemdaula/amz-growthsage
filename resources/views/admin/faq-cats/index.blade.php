    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-x-8 mt-8">
        <div class="relative col-span-3">
            ...
            <div class="bg-white p-4 overflow-x-auto">
                <div class="h3">FAQ Categoris</div>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td>
                                <a href="{{ route('admin.faq-cats.faqs.index', $item->id) }}"><span class="bi-eye"></span></a>
                                <a href="{{ route('admin.faq-cats.edit', $item->id) }}"><span class="bi-pencil"></span></a>
                            </td>
                        </tr>
                        @empty
                        @endforelse
