...
<body>
    ...
    <body class=" font-gilroy font-medium text-gray text-lg leading-[27px]">
                ...
                <div class="container">
                    <div class=" flex items-center justify-between">
                        <a href="index.html" class="brand-logo flex-none lg:mr-10 md:w-auto max-w-[120px] ">
                            <img src="{{ asset('images/logo/logo.svg') }}" alt=""></a>
        ...
        <section
            class=" xl:min-h-screen bg-[url('../../public/images/banner/1.png')] bg-cover bg-no-repeat bg-center overflow-hidden">
            <div class="container relative">
                <div class="max-w-[570px] xl:pt-[297px] md:pt-20 md:pb-20 pt-28 pb-14 xl:pb-40 space-y-8">
                    <h1>
                        Classical
                        <span
                            class=" text-secondary inline-block bg-[url('../../public/images/banner/shape.svg')]  bg-no-repeat bg-bottom">
                            Education</span>
                        For The Future
                    </h1>
                    ...
                    <div>
                        ...
                        <ul class=" list-item space-y-6 pt-8">
                            <li class="flex">
                                <div class="flex-none mr-6">
                                    <div class="h-[72px] w-[72px] rounded-full">
                                        <img src="{{ asset('images/svg/light.svg') }}" alt=""
                            ...
                            <li class="flex">
                                <div class="flex-none mr-6">
                                    <div class="h-[72px] w-[72px] rounded-full">
                                        <img src="{{ asset('images/svg/target.svg') }}" alt=""
                                            class=" w-full h-full object-cover rounded-full block" />
                                    </div>
                                </div>
                                <div class="flex-1">
        ...
        <div class="brands-area section-padding-bottom ">
            <div class="container">
                ...
                <ul class="flex flex-wrap items-center lg:justify-between justify-center  ">
                    ...
                    <li
                        class=" mb-6 last:mb-0 mr-6 last:mr-0  transition duration-150 grayscale-[80] hover:grayscale-0 ">
                        <a href="#" class=" block">
                            <img src="{{ asset('images/all-img/brands/1.svg') }}" alt=""></a>
                    </li>

                    <li
                        class=" mb-6 last:mb-0 mr-6 last:mr-0  transition duration-150 grayscale-[80] hover:grayscale-0 ">
                        <a href="#" class=" block">
                            <img src="{{ asset('images/all-img/brands/2.svg') }}" alt=""></a>
                    </li>

                    <li
                        class=" mb-6 last:mb-0 mr-6 last:mr-0  transition duration-150 grayscale-[80] hover:grayscale-0 ">
                        <a href="#" class=" block">
                            <img src="{{ asset('images/all-img/brands/3.svg') }}" alt=""></a>
                    </li>

                    <li
                        class=" mb-6 last:mb-0 mr-6 last:mr-0  transition duration-150 grayscale-[80] hover:grayscale-0 ">
                        <a href="#" class=" block">
                            <img src="{{ asset('images/all-img/brands/4.svg') }}" alt=""></a>
                    </li>

                    <li
                        class=" mb-6 last:mb-0 mr-6 last:mr-0  transition duration-150 grayscale-[80] hover:grayscale-0 ">
                        <a href="#" class=" block">
                            <img src="{{ asset('images/all-img/brands/5.svg') }}" alt=""></a>
                    </li>
        ...
        <div
            class="feature-area bg-[url('../../public/images/all-img/section-bg-1.png')] bg-cover bg-no-repeat bg-center section-padding">
            <div class="container">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] pt-10">
                  ...
                  text-5xl group-hover:bg-black group-hover:bg-opacity-[0.1] group-hover:text-white transition duration-150">
                        ...
                        <h4
                            class=" lg:text-2xl text-[22px] leading-[30px] mb-4 transition duration-150 group-hover:text-white">
                            Learn More Anywhere</h4>
                        <div class="transition duration-150 group-hover:text-white">Learn from anywhere in world on
        ...
        <div class=" section-padding">
            <div class="container">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] pt-10">
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c1.png') }}" alt=""
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c2.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c3.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c4.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c5.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                    ...
                    <a class=" bg-white shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm"
                        href="#">
                        <div class="course-thumb h-[248px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/c6.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                                class="bg-secondary py-1 px-3 text-lg font-semibold rounded text-white absolute left-6 top-6">Developemet</span>
                        </div>
            ...
            <div class="container">
                <div class="lg:grid grid-cols-12 gap-[30px]">
                    ...
                    <div class="xl:col-span-7 lg:col-span-6 col-span-12 lg:pt-0 md:pt-10 pt-6">
                        <img src="{{ asset('images/all-img/about2.png') }}" alt=""
        ...
        <div class="bg-[url('../images/all-img/section-bg-3.png')] bg-cover bg-no-repeat bg-center py-20">
            <div class="container">
                <div class="lg:flex lg:items-center lg:space-x-[70px]">
                    <div class=" flex-none">
                        <div
                            class="flex items-center space-x-8 text-white max-w-[327px] mx-auto lg:mb-0 md:mb-10 mb-5">
                            <div class=" flex-none ">
            ...
            <div class="container">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t1.svg') }}" alt=""
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t2.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t3.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t4.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t5.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
                            <h4 class=" text-2xl  mb-2 font-bold">Data Science</h4>
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t6.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/icon/t7.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
              ...
              py-[65px] hover:-translate-y-2"
                        ...
                        <div
                            class="w-[72px] h-[72px] rounded-full bg-white relative mx-auto flex flex-col justify-center items-center mb-8 group-hover:bg-[#FFE8E8]">
                            <img src="{{ asset('images/icon/t8.svg') }}" alt=""
                                class=" w-[32px] h-[32px] object-cover ">
                        </div>
                        <div class="course-content">
        ...
        <!-- testtimonal start -->
        <div
            class=" section-padding bg-[url('../images/all-img/section-bg-16.png')] bg-cover  bg-no-repeat lg:mt-[136px]">
            <div class="container lg:-mt-[250px] xl:pb-[136px] lg:pb-20 pb-10">
                <div
                    class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] bg-white shadow-box14 rounded-md
        ...
        <div class=" section-padding">
            <div class="container">
                ...
                <div class="grid xl:grid-cols-4 lg:grid-cols-3  md:grid-cols-2 grid-cols-1 gap-[30px] pt-10">
                    ...
                    <div
                        class=" bg-white shadow-box3 rounded-[8px] transition-all duration-100 pt-10 pb-[28px] px-6 text-center hover:shadow-box4
              border-t-4 border-transparent hover:border-secondary ">
                        <div class="w-[170px] h-[170px] rounded-full  relative mx-auto mb-8">
                            <img src="{{ asset('images/all-img/team1.png') }}" alt=""
                        ...
                        <div class="course-content">
                            ...
                            <ul class="space-x-4 flex justify-center pt-6">
                                <li>
                                    <a href="#"
                                        class=" h-10 w-10 rounded bg-red-paste text-primary flex flex-col justify-center items-center text-2xl transition
                                ...
                                <li>
                                    <a href="#"
                                        class=" h-10 w-10 rounded bg-green-paste text-secondary flex flex-col justify-center items-center text-2xl transition
                                ...
                                <li>
                                    <a href="#"
                                        class=" h-10 w-10 rounded bg-[#EEE8FF] text-#8861DB flex flex-col justify-center items-center text-2xl transition
              ...
              border-t-4 border-transparent hover:border-secondary ">
                        <div class="w-[170px] h-[170px] rounded-full  relative mx-auto mb-8">
                            <img src="{{ asset('images/all-img/team2.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-full">
                        </div>
                        <div class="course-content">
              ...
              border-t-4 border-transparent hover:border-secondary ">
                        <div class="w-[170px] h-[170px] rounded-full  relative mx-auto mb-8">
                            <img src="{{ asset('images/all-img/team3.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-full">
                        </div>
                        <div class="course-content">
              ...
              border-t-4 border-transparent hover:border-secondary ">
                        <div class="w-[170px] h-[170px] rounded-full  relative mx-auto mb-8">
                            <img src="{{ asset('images/all-img/team4.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-full">
                        </div>
                        <div class="course-content">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] pt-7">
                    ...
                    <div class=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
                        <div class="course-thumb h-[260px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/blog-1.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                        ...
                        <div class="course-content p-8">
                            ...
                            <a href="blog-single.html"
                                class=" text-black font-semibold hover:underline transition duration-150">Read More</a>
                        </div>
                    </div>

                    <div class=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
                        <div class="course-thumb h-[260px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/blog-2.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                                class="bg-secondary py-1 px-3 text-lg font-semibold rounded text-white absolute left-6 top-6">Education</span>
                        </div>
                    ...
                    <div class=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
                        <div class="course-thumb h-[260px] rounded-t-[8px]  relative">
                            <img src="{{ asset('images/all-img/blog-3.png') }}" alt=""
                                class=" w-full h-full object-cover rounded-t-[8px]">
                            <span
                                class="bg-secondary py-1 px-3 text-lg font-semibold rounded text-white absolute left-6 top-6">Education</span>
                        </div>
