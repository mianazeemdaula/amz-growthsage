                    ...
                    <div class=" grid grid-cols-12 gap-[30px]">
                        ...
                        <div class="xl:col-span-7 lg:col-span-6 col-span-12">
                            <div class="bg-white shadow-box7 p-8 rounded-md">
                                <form class="form" method="post" action="{{ route('users.store') }}" onsubmit="return validation(event)">
                                    @csrf
                                    <div class="md:grid-cols-2 grid grid-cols-1 gap-[30px] mt-6 ">
                                        ...
                                        <div>
                                            <input type="password" id='confirm' name="confirm" class=" from-control" placeholder="Confirm Password*" required>
                                        </div>

                                        <div>
                                            <input type="text" id='confirm' name="referral" class=" from-control" placeholder="Referral" value="{{ request()->code ?? '' }}" readonly>
                                        </div>
