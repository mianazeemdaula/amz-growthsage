            ...
            @if (session('success'))
                <div class="container">
                    <div class="flex flex-col justify-center items-center bg-green-100 rounded-lg text-xl p-8 my-16">
                        ...
                        <p class="text-slate-800 mt-6">We have recieved your query successfully. Soon our representative
                            will respond to your query</p>
                    </div>
                </div>
            @else
                <div class="container">
                        ...
                        <div class="container">
                            <div class=" grid grid-cols-12 gap-[30px]">
                                <div class="xl:col-span-5 lg:col-span-6 col-span-12 ">
                                    ...
                                    <div>
                                        Feel free to place your Amazon related query. Our support team is quick to respond,
                                        ensuring that no question goes unanswered.
                                    </div>
