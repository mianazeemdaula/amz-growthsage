...
<div class="container px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-x-8">
        ...
        @endif
        @if($step==1)
        <div class="col-span-2 p-6 rounded-lg bg-white">
        ...
        <div class="col-span-2 p-6 rounded-lg bg-white">
            ...
            <!-- payment option -->
            <div class="grid grid-cols-1 md:grid-cols-2 rounded-lg border-slate-300">
                <div class="h3 col-span-2">Payments Options</div>
                <div class="divider my-6 col-span-2"></div>
                <div class="px-8">
                ...
                <div class="px-8 border-l boder-dashed border-slate-300">
                    <div class="flex justify-center">
            ...
            <form action="{{route('registration.store')}}" method='post' class="flex flex-col w-full mt-4" enctype="multipart/form-data" onsubmit="return validate(event)">
                ...
                <input type="hidden" name='course_id' value="">
                <div>
                    <button type="submit" class="btn-blue">Upload Payment Proof</button>
                </div>
            </form>
        </div>
        @endif
