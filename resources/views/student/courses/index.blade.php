    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-x-8">
        <div class="relative col-span-2">
            ...
            <div class="p-6 rounded-lg  bg-white mt-6">
                ...
                @if(Auth::user()->enrollments()->in(1)->count()==0)
                <div class="flex justify-between">
                    <div class="h3">Registration Status</div>
                    <div class="text-red-800 font-bold text-sm">Not Registered</div>
                </div>
                <div class="mt-8">
                    <a href="{{url('course-enrollments/create')}}" class="btn-blue">Register Now</a>
                </div>
                @else
                <div class="flex justify-between">
                    <div class="h3">Registration Status</div>
                    <div class="text-red-800 font-bold text-sm">Status</div>
                </div>
                <div class="mt-8">
                    <a href="" class="btn-blue">See Content</a>
                </div>
                @endif
