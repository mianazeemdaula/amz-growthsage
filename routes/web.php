...
Route::get('/', function () {
    if (Auth::check()) {
        if (Auth::user()->hasRole('student|teamleader'))
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['role:admin']], function () {
    ...
    Route::view('admin/change/pw', 'admin.change_password')->name('changepw');
    Route::post('admin/change/pw', [AdminController::class, 'changePassword'])->name('change_password');
});
